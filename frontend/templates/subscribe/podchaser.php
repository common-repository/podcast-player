...
<?php Markup_Fn::the_icon( array( 'icon' => 'pp-podchaser' ) ); ?>
<span class="sub-text">
	<span class="sub-listen-text"><?php esc_html_e( 'Listen On', 'podcast-player' ); ?></span>
	<span class="sub-item-text" style="letter-spacing: 0.2em; font-size: 13px; color: #777; font-weight: normal;"><?php esc_html_e( 'PODCHASER', 'podcast-player' ); ?></span>
</span>
