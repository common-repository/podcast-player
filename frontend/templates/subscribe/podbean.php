...
<?php Markup_Fn::the_icon( array( 'icon' => 'pp-podbean' ) ); ?>
<span class="sub-text">
	<span class="sub-listen-text"><?php esc_html_e( 'Available on', 'podcast-player' ); ?></span>
	<span class="sub-item-text" style="font-size: 15px; letter-spacing: 0.025em;"><?php esc_html_e( 'Podbean', 'podcast-player' ); ?></span>
</span>
