...
<?php Markup_Fn::the_icon( array( 'icon' => 'pp-playerfm' ) ); ?>
<span class="sub-text">
	<span class="sub-listen-text"><?php esc_html_e( 'Listen On', 'podcast-player' ); ?></span>
	<span class="sub-item-text">
		<span><?php esc_html_e( 'Player', 'podcast-player' ); ?></span>
		<span style="font-weight: normal;"><?php esc_html_e( 'FM', 'podcast-player' ); ?></span>
	</span>
</span>
