...
<?php Markup_Fn::the_icon( array( 'icon' => 'pp-deezer' ) ); ?>
<span class="sub-text">
	<span class="sub-listen-text"><?php esc_html_e( 'Listen On', 'podcast-player' ); ?></span>
	<span class="sub-item-text" style="font-size: 18px;"><?php esc_html_e( 'deezer', 'podcast-player' ); ?></span>
</span>
