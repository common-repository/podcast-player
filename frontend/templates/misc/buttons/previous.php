 ...
 *
 * This template can be overridden by copying it to yourtheme/podcast-player/misc/buttons/previous.php.
 *
...
<div class="ppjs__button"><button class="pp-prev-btn">
	<span class="ppjs__offscreen"><?php esc_html_e( 'Previous Episode', 'podcast-player' ); ?></span>
