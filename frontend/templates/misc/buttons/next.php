 ...
 *
 * This template can be overridden by copying it to yourtheme/podcast-player/misc/buttons/next.php.
 *
...
<div class="ppjs__button"><button class="pp-next-btn">
	<span class="ppjs__offscreen"><?php esc_html_e( 'Next Episode', 'podcast-player' ); ?></span>
